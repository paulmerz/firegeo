...
import { analyzePromptWithProvider, calculateBrandScores, analyzeCompetitors, identifyCompetitors, analyzeCompetitorsByProvider } from './ai-utils';
...
export async function performAnalysis({
  ...
  if (!customPrompts || customPrompts.length === 0) {
    throw new Error('No prompts provided for analysis. Prompts should always be generated by the UI.');
  }
