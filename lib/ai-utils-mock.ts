...
const MOCK_RAW_RESPONSES: Array<{ provider: string; category: string; response: string; sources?: { url: string; title?: string }[] }> = [
  // RANKING prompts
  {
    provider: 'OpenAI',
    category: 'ranking',
    ...
    sources: [
      { url: 'https://www.grand-seiko.com/', title: 'Grand Seiko' },
      { url: 'https://www.ysl.com/', title: 'Yves Saint Laurent' },
      { url: 'https://www.caterhamcars.com/', title: 'Caterham Cars' }
    ]
  },
  {
    provider: 'Anthropic',
    ...
    sources: [
      ...
      { url: 'https://www.patek.com/', title: 'Patek Philippe' },
      { url: 'https://www.audemarspiguet.com/', title: 'Audemars Piguet' }
    ]
  },
  {
    provider: 'Google',
    ...
    sources: [
      { url: 'https://www.vacheron-constantin.com/', title: 'Vacheron Constantin' },
      { url: 'https://www.omegawatches.com/', title: 'Omega' },
      { url: 'https://www.jaeger-lecoultre.com/', title: 'Jaeger-LeCoultre' }
    ]
  },
  {
    provider: 'Perplexity',
  ...
  },
  {
    ...
    sources: [
      { url: 'https://www.cartier.com/', title: 'Cartier' },
      { url: 'https://www.omegawatches.com/', title: 'Omega' }
    ]
  },
  {
  ...
  // ALTERNATIVES prompts
  {
    ...
    sources: [
      ...
      { url: 'https://www.theheinekencompany.com/', title: 'Heineken' },
  ...
  },
  {
    ...
    sources: [
      { url: 'https://www.omegawatches.com/', title: 'Omega' },
      { url: 'https://www.tudorwatch.com/', title: 'Tudor' },
      { url: 'https://www.breitling.com/', title: 'Breitling' }
    ]
  },
  {
    provider: 'Google',
    ...
    sources: [
      { url: 'https://www.iwc.com/', title: 'IWC' },
      { url: 'https://www.panerai.com/', title: 'Panerai' },
      { url: 'https://www.grand-seiko.com/', title: 'Grand Seiko' }
    ]
  },
  {
  ...
  },
  {
    ...
    sources: [
      { url: 'https://www.cartier.com/', title: 'Cartier' },
      { url: 'https://www.alange-soehne.com/', title: 'A. Lange & Söhne' }
    ]
  },
  {
    provider: 'Google',
...
/**
 * Get mocked sources for a specific provider and prompt
 */
export function getMockedSources(provider: string, prompt: string): { url: string; title?: string }[] {
  const category = detectPromptCategory(prompt);
  const match = MOCK_RAW_RESPONSES.find(r => r.provider === provider && r.category === category);
